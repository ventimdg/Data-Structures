...
public class BuggyIntDListTest {
    ...
    @Test
    public void testsolt() {
        assertEquals(2, BuggyIntDList.solution(new int[]{1,2,1}, 2));
        assertEquals(0, BuggyIntDList.solution(new int[]{1,2,1}, 3));
        assertEquals(0, BuggyIntDList.solution(new int[]{1,2,1,2,1,2,1}, 3));
        assertEquals(6, BuggyIntDList.solution(new int[]{1,2,1,2,1,2,1}, 2));
    }
